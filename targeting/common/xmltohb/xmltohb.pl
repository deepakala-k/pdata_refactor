...
# present in the set. Even if there are virtual attributes, they can also e removed.
# so filtering it before doing any operations. $allAttributes to contain the actual list
