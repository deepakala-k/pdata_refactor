...
loadAllowedFilterList( $attr_filter_file, \%allowed_attr_list,
    "/allowedAttributes/attribute", \$attr_filter_is_active );

my %allowed_tgt_list;
my $tgt_filter_is_active;
loadAllowedFilterList( $target_filter_file, \%allowed_tgt_list, "/allowedTargets/targetType", \$tgt_filter_is_active );
