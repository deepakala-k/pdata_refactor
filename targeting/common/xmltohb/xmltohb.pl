...
my @associationTypes = (
    PARENT_BY_CONTAINMENT, CHILD_BY_CONTAINMENT, PARENT_BY_AFFINITY, CHILD_BY_AFFINITY,
    PERVASIVE_CHILD,       PARENT_PERVASIVE,     OMIC_PARENT,        OMI_CHILD,
    PAUC_CHILD,            PAUC_PARENT
);
...
my $allAttributes = $xml->XMLin( $cfgHbXmlFile,
    forcearray => [ 'enumerationType', 'enumerator', 'attribute', 'hwpfToHbAttrMap', 'compileAttribute', 'range' ] );

my $fapiAttributes = {};
if ( $cfgFapiAttributesXmlFile ne "" )
{
    $fapiAttributes = $xml->XMLin( $cfgFapiAttributesXmlFile, forcearray => ['attribute'] );
}
...
foreach my $targetType ( @{ $attributes->{targetType} } )
{
    ...
    {
        for my $attr ( reverse 0 .. ( ( scalar @{ $targetType->{attribute} } ) - 1 ) )
        {
...
if ( !( $cfgSrcOutputDir =~ "none" ) )
{
    ...
    open( ATTR_TARG_MAP_FILE, ">$cfgSrcOutputDir" . "targAttrOverrideData.H" )
        or croak( "Target Attribute data file: \"$cfgSrcOutputDir" . "targAttrOverrideData.H\" could not be opened." );
    ...
    open( ATTR_ID_MAP_H_FILE, ">$cfgSrcOutputDir" . "targAttrIdToName.H" )
        or croak(
        "Target Attribute ID to Name map H file: \"$cfgSrcOutputDir" . "targAttrIdToName.H\" could not be opened." );
    ...
    open( ATTR_ID_MAP_C_FILE, ">$cfgSrcOutputDir" . "targAttrIdToName.C" )
        or croak(
        "Target Attribute ID to Name map C file: \"$cfgSrcOutputDir" . "targAttrIdToName.C\" could not be opened." );
    ...
    open( ATTR_DUMP_C_FILE, ">$cfgSrcOutputDir" . "targeting_dump.C" )
        or croak(
        "Targeting dump file: \"$cfgSrcOutputDir" . "targeting_dump.C\" could not be opened." );
    my $targDumpCFile = *ATTR_DUMP_C_FILE;
    writeTargetingDumpSourceFile( $attributes, $targDumpCFile );
    close $targDumpCFile;

    open( MUTEX_ATTR_FILE, ">$cfgSrcOutputDir" . "mutexattributes.H" )
        or croak( "Mutex Attribute file: \"$cfgSrcOutputDir" . "mutexattributes.H\" could not be opened." );
    ...
    open( TRAIT_FILE, ">$cfgSrcOutputDir" . "attributetraits.H" )
        or croak( "Trait file: \"$cfgSrcOutputDir" . "attributetraits.H\" could not be opened." );
    ...
    open( ATTR_FILE, ">$cfgSrcOutputDir" . "attributeenums.H" )
        or croak( "Attribute enum file: \"$cfgSrcOutputDir" . "attributeenums.H\" could not be opened." );
    ...
    open( STRING_HEADER_FILE, ">$cfgSrcOutputDir" . "attributestrings.H" )
        or croak( "Attribute string header file: \"$cfgSrcOutputDir" . "attributestrings.H\" could not be opened." );
    ...
    open( STRING_IMPLEMENTATION_FILE, ">$cfgSrcOutputDir" . "attributestrings.C" )
        or croak( "Attribute string source file: \"$cfgSrcOutputDir" . "attributestrings.C\" could not be opened." );
    ...
    open( STRUCTS_HEADER_FILE, ">$cfgSrcOutputDir" . "attributestructs.H" )
        or croak( "Attribute struct file: \"$cfgSrcOutputDir" . "attributestructs.H\" could not be opened." );
    ...
    open( PNOR_HEADER_DEF_FILE, ">$cfgSrcOutputDir" . "pnortargeting.H" )
        or croak(
        "Targeting header definition header file: \"$cfgSrcOutputDir" . "pnortargeting.H\" could not be opened." );
    ...
    writeFapi2PlatAttrMacrosHeaderFileContent( $attributes, $fapiAttributes, $fapi2PlatAttrMacrosHeaderFile );
    ...
    open( ATTR_ATTRERRL_C_FILE, ">$cfgSrcOutputDir" . "errludattribute_gen.C" )
        or croak( "Attribute errlog C file: \"$cfgSrcOutputDir" . "errludattribute_gen.C\" could not be opened." );
    ...
    open( ATTR_ATTRERRL_H_FILE, ">$cfgSrcOutputDir" . "errl/errludattributeP_gen.H" )
        or
        croak( "Attribute errlog H file: \"$cfgSrcOutputDir" . "errl/errludattributeP_gen.H\" could not be opened." );
    my $attrErrlHFile = *ATTR_ATTRERRL_H_FILE;

    open( ATTR_ATTRERRL_PY_FILE, ">$cfgSrcOutputDir" . "errl/errludattributeP_gen.py" )
        or
        croak( "Attribute errlog PY file: \"$cfgSrcOutputDir" . "errl/errludattributeP_gen.py\" could not be opened." );
    ...
    open( ATTR_TARGETERRL_C_FILE, ">$cfgSrcOutputDir" . "errludtarget.C" )
        or croak( "Target errlog C file: \"$cfgSrcOutputDir" . "errludtarget.C\" could not be opened." );
    ...
    open( ATTR_TARGETERRL_H_FILE, ">$cfgSrcOutputDir" . "errl/errludtarget.H" )
        or croak( "Target errlog H file: \"$cfgSrcOutputDir" . "errl/errludtarget.H\" could not be opened." );
    my $targetErrlHFile = *ATTR_TARGETERRL_H_FILE;
    open( ATTR_ENTITYPATH_PY_FILE, ">$cfgSrcOutputDir" . "errl/entityPath.py" )
        or croak( "Target errlog Python file: \"$cfgSrcOutputDir" . "errl/entityPath.py\" could not be opened." );
    my $entityPathPYFile = *ATTR_ENTITYPATH_PY_FILE;
    open( ATTR_TARGETERRL_PY_FILE, ">$cfgSrcOutputDir" . "errl/errludtarget.py" )
        or croak( "Target errlog Python file: \"$cfgSrcOutputDir" . "errl/errludtarget.py\" could not be opened." );
    ...
    open( ATTR_INFO_CSV_FILE, ">$cfgSrcOutputDir" . "targAttrInfo.csv" )
        or croak( "Attribute info csv file: \"$cfgSrcOutputDir" . "targAttrInfo.csv\" could not be opened." );
    ...
    open( MAP_ATTR_METADATA_H_FILE, ">$cfgSrcOutputDir" . "mapattrmetadata.H" )
        or
        croak( "Attribute metadata map file Header: \"$cfgSrcOutputDir" . "mapattrmetadata.H\" could not be opened." );
    ...
    open( MAP_ATTR_METADATA_C_FILE, ">$cfgSrcOutputDir" . "mapattrmetadata.C" )
        or croak( "Attribute metadata map C file: \"$cfgSrcOutputDir" . "mapattrmetadata.C\" could not be opened." );
    ...
    open( MAP_ATTR_SIZE_H_FILE, ">$cfgSrcOutputDir" . "mapsystemattrsize.H" )
        or croak( "Attribute size map file Header: \"$cfgSrcOutputDir" . "mapsystemattrsize.H\" could not be opened." );
    ...
    open( MAP_ATTR_SIZE_C_FILE, ">$cfgSrcOutputDir" . "mapsystemattrsize.C" )
        or croak( "Attribute size map file: \"$cfgSrcOutputDir" . "mapsystemattrsize.C\" could not be opened." );
    ...
    open( ATTR_SIZES_H_FILE, ">$cfgSrcOutputDir" . "attrsizesdata.H" )
        or croak( "Attribute size file: \"$cfgSrcOutputDir" . "attrsizesdata.H\" could not be opened." );
    ...
    open( ATTR_SIZES_C_FILE, ">$cfgSrcOutputDir" . "attrsizesdata.C" )
        or croak( "Attribute size file: \"$cfgSrcOutputDir" . "attrsizesdata.C\" could not be opened." );
...
if ( !( $cfgImgOutputDir =~ "none" ) )
{
    ...
    generateTargetingImage( $cfgVmmConstsFile, $attributes, \%Target_t,
        $addRO_Section_VerPage, $allAttributes, \$combinedData, \$protectedData, \$unprotectedData );

    # Generate combined targeting file
    open( PNOR_TARGETING_FILE, ">$cfgImgOutputDir" . $cfgImgOutputFile )
        or croak( "Targeting image file: \"$cfgImgOutputDir" . "$cfgImgOutputFile\" could not be opened." );
    ...
    open( PNOR_TARGETING_FILE, ">$cfgImgOutputDir" . "$cfgImgOutputFile.protected" )
        or fatal( "Targeting image file: \"$cfgImgOutputDir" . "$cfgImgOutputFile.protected\" could not be opened." );
    binmode(PNOR_TARGETING_FILE);
    ...
    open( PNOR_TARGETING_FILE, ">$cfgImgOutputDir" . "$cfgImgOutputFile.unprotected" )
        or fatal( "Targeting image file: \"$cfgImgOutputDir" . "$cfgImgOutputFile.unprotected\" could not be opened." );
    binmode(PNOR_TARGETING_FILE);
...
VERBATIM
    ...
    foreach my $attr (@rwPersistAttrs)
    {
            ...
            && exists $attr->{simpleType}->{enumeration} )
        {
            ...
            {
                print $rwAttrCFile "" . "        switch( o_attrValue )\n" . "        {\n";
            }
            foreach my $enumerations ( @{ $atype->{enumerator} } )
            {
                print $rwAttrCFile "" . "            case $atype->{id}_$enumerations->{name}:\n";
            }
    ...
    foreach my $attr (@rwPersistAttrs)
    {
        if ( exists $attr->{range} )
        {
            ...
            if ($isArrayType)
            {
                ...
                print $rwAttrCFile "" . "        for(int i=0; i<$arraySize; i++)\n" . "        {\n";
            ...
            if ( exists $attr->{range} )
            {
                ...
                print $rwAttrCFile "$extraIndent" . "        do {\n$extraIndent";
                for my $range (@ranges)
                {
...
sub validateRangeMinsAndMaxes
{
    ...
    while ( exists $rangeArray[$i]->{min} && exists $rangeArray[$i]->{max} )
    {
        ...
        if ( $prevMax > $rangeArray[$i]->{min} )
        {
            ...
            print Dumper( $rangeArray[$i] );
            die "Range overlap! Previous <max> tag $prevMax " . "exceeds <min> tag value! $rangeArray[$i]->{min}";
        }
        $prevMax = $rangeArray[$i]->{max};
        $i++;
    }
...
sub validateSubElements
{
    ...
    for my $subElementName ( sort( keys %{$element} ) )
    {
        ...
        {
            croak( "$name element cannot have child element of type " . "\"$subElementName\"." );
        }
    }
    ...
    for my $subElementName ( sort( keys %{$criteria} ) )
    {
        ...
        {
            croak( "$name element missing required child element " . "\"$subElementName\"." );
        }
        ...
        {
            croak( "$name element child element \"$subElementName\" should be " . "scalar, but is a hash." );
        }
    }
}
...
sub validateTargetTypesExtension
{
    ...
    {
        validateSubElements( "targetTypeExtension", 1, $targetTypeExtension, \%elements );
    }
}
        ...
        foreach my $attr ( @{ $targetInstance->{attribute} } )
        {
            if ( exists $attr->{default} )
            {
                    ...
                    && ( $attr->{id} eq "PEER_TARGET" ) )
                {
                    ...
                    {
                        croak( "HUID for Peer Target not found for " . "Peer Target [$attr->{default}]\n" );
                    }
    ...
    foreach my $attribute ( @{ $attributes->{attribute} } )
    {
        foreach my $hwpfToHbAttrMap ( @{ $attribute->{hwpfToHbAttrMap} } )
        {
            ...
            if ( $cfgFapiAttributesXmlFile eq "" )
            {
                ...
                {
                    $macroSection .= '    #ifndef ' . $hwpfToHbAttrMap->{id} . "_SETMACRO\n";
                    $macroSection .=
                          '    #define '
                        . $hwpfToHbAttrMap->{id}
            ...
            else
            {
                ...
                foreach my $fapiAttr ( @{ $fapiAttributes->{attribute} } )
                {
                        ...
                        && ( $fapiAttr->{id} eq $hwpfToHbAttrMap->{id} ) )
                    {
                        ...
                        {
                            die "Do not use enumerations for FAPI types! " . $attribute->{id} . "\n";
                        }
                        else
                        {
                            $typeSection .= "    static_assert(sizeof(TARGETING::ATTR_" . $attribute->{id} . "_type) ==
                                            sizeof(fapi2::"
                                . $fapiAttr->{id}
                                . "_Type), \"Size of attribute ATTR_"
                                . $attribute->{id}
                                . "_type is not equal to the size of "
                                . $fapiAttr->{id}
                                . "_Type , types dont match \" );\n";
                        }
                        last;
                    }
                }
                ...
                if ($fapiReadable)
                {
                    ...
                    {
                        croak(
                            "FAPI attribute $hwpfToHbAttrMap->{id} requires " . "platform supply readable attribute." );
                    }
                }
            ...
            if ($instantiated)
            {
                $attrSection .= $hwpfToHbAttrMap->{id} . " = " . "        TARGETING::ATTR_" . $attribute->{id} . ",\n";
            }
        }
    }
            ...
            if ( exists $simpleType->{enumeration} )
            {
                ...
                foreach my $enumerator ( @{ $enumerationType->{enumerator} } )
                {
                    if ( $attribute->{id} eq "TYPE" )
                    {
                        ...
                        {
                            print( EP_TEST_FILE "if( memcmp( name, " . "test_string, size ))\n{\n" );
    ...
    foreach my $attribute ( @{ $attributes->{attribute} } )
    {
        if ( exists $attribute->{complexType} )
        {
            ...
            foreach my $field ( @{ $complex->{field} } )
            {
                ...
                print $outFile "    ", $field->{type}, " ", $field->{name}, $bits, "; \n\n";
            }
...
############# Deepa ####################
sub writeTargetingDumpSourceFile
{
    my ( $attributes, $outFile ) = @_;
...
VERBATIM
    ...
    foreach my $enumerator (@{ $attributeIdEnumeration->{enumerator} }) {
        my $attrId = $enumerator->{name};
        $attrId = "ATTR_" . $attrId;
        if ($attrId ne "ATTR_NA")
        {
            push @lines, "    getAttrAndPrint<$attrId>(tgt);\n";
        }
    }
...
.
    ...
    foreach my $enumerationType ( @{ $attributes->{enumerationType} } )
    {
        ...
        foreach my $enumerator ( @{ $enumerationType->{enumerator} } )
        {
            $enumHexValue = enumNameToValue( $enumerationType, $enumerator->{name} );
            ...
            {
                # find type
                my $simpleType = getAttributeType( $enumerationType->{id}, $attributes );
...
sub isSimpleNumericAttribute
{
    ...
    return (
        ( exists $attribute->{simpleType} ) and ( exists $attribute->{simpleType}->{uint8_t}
            or exists $attribute->{simpleType}->{int8_t}
            or exists $attribute->{simpleType}->{uint16_t}
            or exists $attribute->{simpleType}->{int16_t}
            or exists $attribute->{simpleType}->{uint32_t}
            or exists $attribute->{simpleType}->{int32_t}
            or exists $attribute->{simpleType}->{uint64_t}
            or exists $attribute->{simpleType}->{int64_t} )
    );
}
...
VERBATIM
    ...
    foreach my $attribute ( sort { getAttributeIdHashStr( $a->{id} ) cmp getAttributeIdHashStr( $b->{id} ) }
...
sub writeTargAttrMap
{
    ...
    foreach my $attribute ( sort { $a->{id} cmp $b->{id} } @{ $attributes->{attribute} } )
    {
...
sub writeAttrIdNameMap
{
    ...
    print $outFile "const std::map<uint32_t,const char*>$mapName = {\n";
    ...
    foreach my $attribute ( sort { $a->{id} cmp $b->{id} } @{ $attributes->{attribute} } )
    {
        ...
        if (( $rwOnly and !( exists $attribute->{writeable} ) )
            or ( !$rwOnly
                and ( exists $attribute->{writeable} ) )
            )
        {
            next;
        }
    ...
    foreach my $attribute ( @{ $attributes->{attribute} } )
    {
        ...
        if ( exists $attribute->{simpleType} )
        {
            ...
            for my $typeName ( sort( keys %{$simpleType} ) )
            {
                ...
                {
                    if ( $simpleTypeProperties->{$typeName}{typeName} eq "XMLTOHB_USE_PARENT_ATTR_ENUMERATION_ID" )
                    {
                        ...
                        && ( $simpleTypeProperties->{$typeName}{supportsArray} ) )
                    {
                        ...
                        for my $idx ( 0 .. $#revBounds )
                        {
                            ...
                            if ( $stdArrAddOn ne "" )
                            {
                                $stdArrAddOn = "std::array<$stdArrAddOn, " . "@revBounds[$idx]>";
                            }
                            else
                            {
                                $stdArrAddOn = "std::array<$type, " . "@revBounds[$idx]>";
                            }
                        }
        ...
        {
            croak( "Could not determine attribute data type for attribute " . "$attribute->{id}." );
        }
        ...
        if ( !exists( $attrValHash{ $attribute->{id} } ) )
        {
            ...
            else
            {
                ...
                if ( $type =~ m/int/ )
                {
                    ...
                    print $outFile "        $qualifiers $type $attribute->{id}_INVALID = 0x", ( "FF" x $sizeInBytes ),
                        "$suffix;\n";
                }
            }
            ...
            $typedefs .= "typedef " . $type . " ATTR_" . "$attribute->{id}" . "_type" . $dimensions . ";\n";
                ...
                && ( exists $attribute->{simpleType}->{string} ) )
            {
                ...
                $typedefs .= "const size_t ATTR_" . "$attribute->{id}" . "_max_chars = " . "$size" . ";\n";
            }
            $typedefs .= "\n";

            # Create case definitions for attrSizeLookup function

            $sizefunc .= "    // Get size for ATTR_$attribute->{id}" . " attribute\n";
...
sub writeAttrErrlCFile
{
    ...
    my @allowed_attributes = (
        "SERIAL_NUMBER", "PART_NUMBER",          "PEC_PCIE_HX_KEYWORD_DATA", "ECID",
        "HUID",          "BOOT_PAU_DPLL_BYPASS", "MASTER_MBOX_SCRATCH"
    );
    ...
    foreach my $attribute ( @{ $attributes->{attribute} } )
    {
        ...
        if (!( exists $attribute->{readable} ) ||    # write-only attributes
            (   exists $attribute->{simpleType} && ( ( exists $attribute->{simpleType}->{hbmutex} )
        ...
        elsif ( exists $attribute->{complexType} )
        {
            ...
            print $outFile "            TRACDCOMP( g_trac_errl, \"ErrlUserDetailsAttribute: ", $attribute->{id},
                " skipped -- complexType\");\n";
        ...
        elsif ( exists $attribute->{nativeType} && ( $attribute->{nativeType}->{name} eq "EntityPath" ) )
        {
            ...
            print $outFile
                "                tmpBuffer = new char[sizeof(lPtype) + lSize + lSize * sizeof(EntityPath::PathElement)];\n";
    ...
    print $outFile
        "        pBuf = reinterpret_cast<uint8_t *>(reallocUsrBuf(iv_dataSize + attrSize + sizeof(i_attr) ));\n";
...
sub writeAttrErrlHFile
{
    ...
    foreach my $attributeId ( sort { $a <=> $b } keys %sortedAttrs )
    {
        ...
        elsif ( isSimpleNumericAttribute($attribute) )
        {
            ...
            {
                print $outFile
                    "              uint32_t offset = sprintf(&(l_traceEntry[0]), \"[$bounds[0]][$bounds[1]]:\");\n";
            ...
            {
                print $outFile
                    "              uint32_t offset = sprintf(&(l_traceEntry[0]), \"[$bounds[0]][$bounds[1]][$bounds[2]]:\");\n";
            ...
            elsif ( exists $attribute->{simpleType}->{int64_t} )
            {
                ...
                print $outFile "              for (uint32_t i = 0;i<$total_count;i++) {\n";
                print $outFile
                    "                  sprintf(&(l_traceEntry[offset+i*19]), \"0x%.16llX \", ntohll(INT64_FROM_PTR(reinterpret_cast<const int64_t*>(l_ptr)+i)));\n";
                print $outFile "              }\n";
...
sub writeAttrMetadataMapCFile
{
    ...
    foreach my $key ( keys %finalAttrhash )
    {
        ...
        elsif (( $finalAttrhash{$key}->{persistency} eq "semi-non-volatile-zeroed" )
        ...
        {
            croak( "Not a defined" . "Persistency[$finalAttrhash{$key}->{persistency}] for" . "attribute [$key]" );
        }
...
sub writeAttrSizeMapCFile
{
                ...
                foreach my $attr ( @{ $attributes->{attribute} } )
                {
                    if ( $attr->{id} eq $key )
                    {
                            ...
                            && ( !( exists $attr->{hbOnly} ) ) )
                        {
                            ...
                            {
                                print STDOUT "\t// Attribute $key is writable " . "& Not Supported \n";
                            }
                        }
                    }
                }
    ...
    foreach my $key ( keys %finalAttrhash )
    {
        print $outFile "    iv_mapSysAttrSize[ATTR_" . "$key] = sizeof($finalAttrhash{$key});\n";
    }
    print $outFile "\n";
}
...
sub getAttributeIdEnumeration
{
    ...
    foreach my $attribute ( @{ $attributes->{attribute} } )
    {
        ...
        if ( exists( $attrValHash{$attributeHexVal28bit} ) )
        {
            ...
            {
                croak(    "Error:Duplicate AttributeId hashvalue for $attribute->{id} "
            ...
            {
                croak( "Error: AttributeId $attribute->{id} " . "defined multiple times" );
            }
        }
        else
        {
            ...
            $enumeration->{enumerator}->[$attributeValue]->{name} =
                $attribute->{id};
            $enumeration->{enumerator}->[$attributeValue]->{value} = sprintf "0x%s", $attributeHexVal28bit;
...
sub pack8byte
{
    ...
    if ($cfgBigEndian)
    {
        $binaryData = pack( "NN", ( ( $value >> 32 ) & 0xFFFFFFFF ), ( $value & 0xFFFFFFFF ) );
    }
    else    # Little endian
    {
        # Invert the words, then reverse them individually
        $binaryData = pack( "VV", ( $value & 0xFFFFFFFF ), ( ( $value >> 32 ) & 0xFFFFFFFF ) );
    }
...
sub enumSpace
{
    ...
    my $space = ( $cfgShortEnums == 1 ) ? ceil( log( $maxEnumVal + 1 ) / ( 8 * log(2) ) ) : 4;
...
sub sizeBlockAligned
{
    ...
    {
        croak( "Caller must specify 'size', 'blockSize', 'oneBlockMinimum' " . "args." );
    }
...
sub defaultEnum
{
    ...
    my $enumerationType = getEnumerationType( $attributes, $enumerationInstance->{id} );
...
sub enforceFspMutex
{
    ...
    if ( $value != 0 )
    {
        croak( "FSP mutex attribute default must always be 0, " . "was $value instead." );
    }

    if ( $attribute->{persistency} ne "volatile-zeroed" )
    {
        croak( "FSP mutex attribute persistency must be volatile-zeroed, " . "was $attribute->{persistency} instead" );
    }
}
...
sub enforceHbMutex
{
    ...
    if ( $value != 0 )
    {
        croak( "HB mutex attribute default must always be 0, " . "was $value instead." );
    }

    if ( $attribute->{persistency} ne "volatile-zeroed" )
    {
        croak( "HB mutex attribute persistency must be volatile-zeroed, " . "was $attribute->{persistency} instead" );
    }
}
...
sub simpleTypeProperties
{
    ...
    $typesHoH{"string"} = {
        supportsArray      => 1,
        canBeHex           => 0,
        complexTypeSupport => 0,
        typeName           => "char",
        bytes              => 1,
        bits               => 8,
        default            => \&defaultString,
        alignment          => 1,
        specialPolicies    => \&enforceString,
        packfmt            => \&packString
    };
    $typesHoH{"int8_t"} = {
        supportsArray      => 1,
        canBeHex           => 1,
        complexTypeSupport => 1,
        typeName           => "int8_t",
        bytes              => 1,
        bits               => 8,
        default            => \&defaultZero,
    ...
    $typesHoH{"enumeration"} = {
        ...
        canBeHex           => 1,
        complexTypeSupport => 0,
        typeName           => "XMLTOHB_USE_PARENT_ATTR_ENUMERATION_ID",
        bytes              => 0,
        bits               => 0,
        default            => \&defaultEnum,
        alignment          => 1,
        specialPolicies    => \&null,
        packfmt            => "packEnumeration"
    };
    $typesHoH{"hbmutex"} = {
        supportsArray      => 1,
        canBeHex           => 1,
        ...
        default            => \&defaultZero,
        alignment          => 8,
        specialPolicies    => \&enforceHbMutex,
        packfmt            => \&packMutex
    };
    $typesHoH{"hbrecursivemutex"} = {
        supportsArray      => 1,
        canBeHex           => 1,
        complexTypeSupport => 0,
        typeName           => "mutex_t*",
    ...
    $typesHoH{"fspmutex"} = {
        ...
        default            => \&defaultZero,
        alignment          => 8,
        specialPolicies    => \&enforceFspMutex,
        packfmt            => \&pack8byte
    };
                ...
                for my $type ( sort( keys %{$simpleTypeProperties} ) )
                {
                    ...
                    if ( exists $attribute->{simpleType}->{$type} )
                    {
                        ...
                        if (   ( exists $attribute->{simpleType}->{$type}->{default} )
                            && ( ref( $attribute->{simpleType}->{$type}->{default} ) ne "HASH" ) )
                        {
                            $default =
...
sub getTargetAttributes
{
    ...
    foreach my $targetType ( @{ $attributes->{targetType} } )
    {
        if ( $targetType->{id} eq $type )
        {
            ...
            {
                getTargetAttributes( $targetType->{parent}, $attributes, $attrhasha );
            }
            ...
            foreach my $attr ( @{ $targetType->{attribute} } )
            {
                ...
                {
                    my $mergedFields = mergeComplexAttributeFields( $attr, $attrhasha->{ $attr->{id} } );
...
sub packEnumeration
{
    ...
    for ( my $count = $bytes - 1; $count >= 0; $count-- )
    {
        ...
        {
            $binaryData .= pack1byte( 0xFF & ( $value >> ( 8 * ( $bytes - 1 - $count ) ) ) );
        }
    }
...
sub enumNameToValue
{
    ...
    if ( $enumeratorValue < 0 )
    {
        ...
        croak( "Negative enumeration value found $enumeration->{id}," . " $enumeratorValue" );
    }
...
sub isFspTargetInstance
{
    ...
    else
    {
        %g_fspTargetTypesCache =
            map { $_->{id} => exists $_->{fspOnly} ? 1 : 0 } @{ $attributes->{targetType} };
        $fspTargetInstance = $g_fspTargetTypesCache{ $targetInstance->{type} };
    }
...
################################################################################
    ...
    sub accumulate
    {
        ...
        {
            if ( $self->{_bits} + $bits > $simpleTypeProperties->{ $self->{_currentType} }{bits} )
            {
...
################################################################################
    ...
    sub releaseAndClear
    {
        ...
        if ( $self->{_currentType} ne "" )
        {
            ...
            if ($cfgBigEndian)
            {
                $binaryData = pack( "B$simpleTypeProperties->{$self->{_currentType}}{bits}", $self->{_accumulator} );
            }
        ...
        foreach my $default ( @{ $attributeDefault->{field} } )
        {
            if ( $default->{id} eq $field->{name} )
            {
                ...
                else
                {
                    ...
                    {
                        $binaryData .= packEntityPath( $attributes, $default->{value}, $attrhash );
                    }

                    # If not a defined simple type, process as an enumeration
                    elsif ( !exists $simpleTypeProperties->{ $field->{type} } )
                    {
                        my $enumerationType = getEnumerationType( $attributes, $field->{type} );
                    ...
                    # (possibly workaround) callback function
                        ...
                        && $simpleTypeProperties->{ $field->{type} }{complexTypeSupport} )
                    {
                        ...
                        if ( ref( $simpleTypeProperties->{ $field->{type} }{packfmt} ) eq "CODE" )
                        {
                            $binaryData .= $simpleTypeProperties->{ $field->{type} }{packfmt}->($defaultValue);
                        }
                        else
                        {
                            $binaryData .= pack( $simpleTypeProperties->{ $field->{type} }{packfmt}, $defaultValue );
                        }
                    }
                    else
                    {
                        croak( "Field type $field->{type} not supported in " . "complex type." );
                    }
                }
...
sub packEntityPath
{
    ...
    if ($cfgBigEndian)
    {
        $binaryData .= pack1byte( ( 0xF0 & ( $type << 4 ) ) + ( 0x0F & ( scalar @paths ) ) );
    }
    else    # Little endian
    {
        $binaryData .= pack1byte( ( 0x0F & ($type) ) + ( 0xF0 & ( ( scalar @paths ) << 4 ) ) );
    }
    ...
    foreach my $pathElement (@paths)
    {
        ...
        foreach my $attr ( @{ $attributes->{attribute} } )
        {
            ...
            {
                $pathType =
                    enumNameToValue( getEnumerationType( $attributes, $attr->{simpleType}->{enumeration}->{id} ),
                    $pathType );
...
sub packSingleSimpleTypeAttribute
{
    ...
    {
        my $enumeration = getEnumerationType( $$attributesRef, $simpleType->{enumeration}->{id} );
    ...
    else
    {
            ...
            && ( $valueIsNegative eq 'false' ) )
        {
            ...
            my $enumeration = getEnumerationType( $$attributesRef, $$attributeRef->{id} );
        ...
        {
            $$binaryDataRef .= $simpleTypeProperties->{$typeName}{packfmt}->( $value, $$attributeRef );
        }
        else
        {
            $$binaryDataRef .= pack( $simpleTypeProperties->{$typeName}{packfmt}, $value );
        }
    }
}
...
sub ASSOC_ENTER
{
    ...
    {
        my ($trace) = @_;
        my ($package,  $filename,   $line,  $undef,   $hasargs, $wantarray,
...
sub updateTargetAssociationPointers
{
    ...
    foreach my $id ( keys %$targetAddrHashRef )
    {
        ...
        foreach my $associationType (@associationTypes)
        {
            ...
            my $seek    = $targetAddrHashRef->{$id}{ "offsetToPtrTo" . $associationType . "Associations" };
            ...
            {
                my $val = sprintf( "%02x",
                    ( ( $myPointer >> ( ( BYTE_RIGHT_BIT_INDEX - $pointerByte ) * BITS_PER_BYTE ) ) & LOW_BYTE_MASK ) );
                ASSOC_IMP("Writing byte value : $val");
                vec( $$targetsBinDataRef, $seek + $pointerByte, BITS_PER_BYTE ) = hex($val);
            }
        }
    }
...
{
    my ( $offsetWithinBinary, $targetsAoHRef, $targetAddrHashRef, $associationsBinDataRef ) = @_;
    ASSOC_ENTER();
    ...
    foreach my $targetInstance (@$targetsAoHRef)
    {
        ...
        foreach my $associationType (@associationTypes)
        {
            $targetAddrHashRef->{$id}{ $associationType . "Ptr" } = $offsetWithinBinary;
            ASSOC_DBG("Offset within binary = $offsetWithinBinary");
            my $pointers = "Association = $associationType, pointers = ";
            foreach my $pointer ( @{ $targetAddrHashRef->{$id}{ $associationType . "Associations" } } )
            {
...
sub generateTargetingImage
{
    my ( $vmmConstsFile, $attributes, $Target_t, $addRO_Section_VerPage,
        $allAttributes, $combinedDataRef, $protectedDataRef, $unprotectedDataRef )
        = @_;
    ...
    foreach my $targetType (@targetTypes)
    {
        ...
        for my $attributeId ( sort { getAttributeIdHashStr($a) cmp getAttributeIdHashStr($b) } ( keys %attrhash ) )
        {
            $perTargetTypeAttrBinData .=
                packEnumeration( $attributeIdEnumeration, enumNameToValue( $attributeIdEnumeration, $attributeId ) );
        }
    ...
    foreach my $targetInstance ( @{ $attributes->{targetInstance} } )
    {
        if ( ( $targetInstance->{type} =~ m/^sys-sys-/ ) && ( $targetSysCnt == 0 ) )
        {
            ...
            (      ( $targetInstance->{type} eq "enc-node-power8" )
                || ( $targetInstance->{type} eq "enc-node-power9" )
                || ( $targetInstance->{type} eq "enc-node-power10" )
            )
            && ( $targetNodeCnt == 0 )
            )
        {
    ...
    foreach my $targetInstance (@targetsAoH)
    {
        ...
        $data .= pack4byte( $attributeListTypeHoH{ $targetInstance->{type} }{elements} );
        $data .= pack8byte( $attributeListTypeHoH{ $targetInstance->{type} }{offset} + $pnorRoBaseAddress );
        ...
        my $id = $targetInstance->{id};
        $targetAddrHash{$id}{offsetToPtrToParentByContainmentAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToParentByContainmentAssociations);

        $targetAddrHash{$id}{offsetToPtrToChildByContainmentAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToChildByContainmentAssociations);

        $targetAddrHash{$id}{offsetToPtrToParentByAffinityAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToParentByAffinityAssociations);

        $targetAddrHash{$id}{offsetToPtrToChildByAffinityAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToChildByAffinityAssociations);

        $targetAddrHash{$id}{offsetToPtrToPervasiveChildAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToPervasiveChildAssociations);

        $targetAddrHash{$id}{offsetToPtrToParentPervasiveAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToParentPervasiveAssociations);

        $targetAddrHash{$id}{offsetToPtrToOmiChildAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToOmiChildAssociations);

        $targetAddrHash{$id}{offsetToPtrToOmicParentAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToOmicParentAssociations);

        $targetAddrHash{$id}{offsetToPtrToPaucChildAssociations} = $offsetWithinTargets + length $data;
        $data .= pack8byte($ptrToPaucChildAssociations);

        $targetAddrHash{$id}{offsetToPtrToPaucParentAssociations} = $offsetWithinTargets + length $data;
        ...
        if ( $id =~ /^sys\d+$/ )
        {
            ...
            for ( my $reserved = 0; $reserved < MAX_COMPUTE_AND_CONTROL_NODE_SUM - 1; ++$reserved )
            {
                unshift
        ...
        $attrAddr += $attributeListTypeHoH{ $targetInstance->{type} }{elements} * ( length pack8byte(0) );
    ...
    foreach my $targetInstance (@targetsAoH)
    {
        ...
        foreach my $targetInstanceAttribute ( @{ $targetInstance->{attribute} } )
        {
                ...
                && ( exists $targetInstanceAttribute->{default} ) )
            {
                ...
                if ( ref( $targetInstanceAttribute->{default} ) eq "HASH" )
                {
                    ...
                    my $defaultFields = mergeComplexAttributeFields( $targetInstanceAttribute, $attrData );
        ...
        for my $attributeId ( sort { getAttributeIdHashStr($a) cmp getAttributeIdHashStr($b) } ( keys %attrhash ) )
        {
            ...
            my $attrValue = enumNameToValue( $attributeIdEnumerationAll, $attributeId );
            ...
            {
                croak(
                    "Persistency '$attributeDef->{persistency}' is not " . "supported for attribute '$attributeId'." );
            }
            ...
            if ( $section eq "pnor-ro" )
            {
                ...
                my ( $rodata, $alignment ) =
                    packAttribute( $attributes, $attributeDef, $attrhash{$attributeId}->{default}, \%attrhash );

                # Align the data as necessary
                my $pads = ( $alignment - ( $offset % $alignment ) ) % $alignment;
                $roAttrBinData .= pack( "@" . $pads );
                $offset += $pads;

                $attributePointerBinData .= pack8byte( $offset + $pnorRoBaseAddress );
            ...
            elsif ( $section eq "pnor-rw" )
            {
                ...
                push @attrDataforSM, [ $attrValue, $huidValue, $hex, $section, $targetInstance->{id}, $attributeId ];

                # Align the data as necessary
                my $pads = ( $alignment - ( $rwOffset % $alignment ) ) % $alignment;
                $rwAttrBinData .= pack( "@" . $pads );
                $rwOffset += $pads;

                $attributePointerBinData .= pack8byte( $rwOffset + $pnorRwBaseAddress );
            ...
            elsif ( $section eq "heap-zero-initialized" )
            {
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $heapZeroInitOffset % $alignment ) ) % $alignment;
                $heapZeroInitBinData .= pack( "@" . $pads );
                $heapZeroInitOffset += $pads;

                $attributePointerBinData .= pack8byte( $heapZeroInitOffset + $heapZeroInitBaseAddr );
            ...
            elsif ( $section eq "heap-pnor-initialized" )
            {
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $heapPnorInitOffset % $alignment ) ) % $alignment;
                $heapPnorInitBinData .= pack( "@" . $pads );
                $heapPnorInitOffset += $pads;

                $attributePointerBinData .= pack8byte( $heapPnorInitOffset + $heapPnorInitBaseAddr );
            ...
            elsif ( $section eq "fspP0DefaultedFromZero" )
            {
                ...
                if ( $ifFspOnlyTargetWithCommonAttr eq "true" )
                {
                    ...
                    push @attrDataforSM,
                        [ $attrValue, $huidValue, $hex, $section, $targetInstance->{id}, $attributeId ];
                    $ifFspOnlyTargetWithCommonAttr = "false";
                }

                # Align the data as necessary
                my $pads = ( $alignment - ( $fspP0DefaultedFromZeroOffset % $alignment ) ) % $alignment;
                $fspP0DefaultedFromZeroBinData .= pack( "@" . $pads );
                $fspP0DefaultedFromZeroOffset += $pads;

                $attributePointerBinData .=
                    pack8byte( $fspP0DefaultedFromZeroOffset + $fspP0DefaultedFromZeroBaseAddr );
            ...
            elsif ( $section eq "fspP0DefaultedFromP3" )
            {
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $fspP0DefaultedFromP3Offset % $alignment ) ) % $alignment;
                $fspP0DefaultedFromP3BinData .= pack( "@" . $pads );
                $fspP0DefaultedFromP3Offset += $pads;

                $attributePointerBinData .= pack8byte( $fspP0DefaultedFromP3Offset + $fspP0DefaultedFromP3BaseAddr );
            ...
            {
                my ( $fspP3RoData, $alignment ) =
                    packAttribute( $attributes, $attributeDef, $attrhash{$attributeId}->{default}, \%attrhash );

                # Align the data as necessary
                my $pads = ( $alignment - ( $fspP3RoOffset % $alignment ) ) % $alignment;
                $fspP3RoBinData .= pack( "@" . $pads );
                $fspP3RoOffset += $pads;

                $attributePointerBinData .= pack8byte( $fspP3RoOffset + $fspP3RoBaseAddr );
            ...
            elsif ( $section eq "fspP3Rw" )
            {
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $fspP3RwOffset % $alignment ) ) % $alignment;
                $fspP3RwBinData .= pack( "@" . $pads );
                $fspP3RwOffset += $pads;

                $attributePointerBinData .= pack8byte( $fspP3RwOffset + $fspP3RwBaseAddr );
            ...
            elsif ( $section eq "fspP1DefaultedFromZero" )
            {
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $fspP1DefaultedFromZeroOffset % $alignment ) ) % $alignment;
                $fspP1DefaultedFromZeroBinData .= pack( "@" . $pads );
                $fspP1DefaultedFromZeroOffset += $pads;

                $attributePointerBinData .=
                    pack8byte( $fspP1DefaultedFromZeroOffset + $fspP1DefaultedFromZeroBaseAddr );
            ...
            elsif ( $section eq "fspP1DefaultedFromP3" )
            {
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $fspP1DefaultedFromP3Offset % $alignment ) ) % $alignment;
                $fspP1DefaultedFromP3BinData .= pack( "@" . $pads );
                $fspP1DefaultedFromP3Offset += $pads;

                $attributePointerBinData .= pack8byte( $fspP1DefaultedFromP3Offset + $fspP1DefaultedFromP3BaseAddr );
            ...
            {
                my ( $hbHeapZeroInitData, $alignment ) =
                    packAttribute( $attributes, $attributeDef, $attrhash{$attributeId}->{default}, \%attrhash );
                ...
                # Align the data as necessary
                my $pads = ( $alignment - ( $hbHeapZeroInitOffset % $alignment ) ) % $alignment;
                $hbHeapZeroInitBinData .= pack( "@" . $pads );
                $hbHeapZeroInitOffset += $pads;

                $attributePointerBinData .= pack8byte( $hbHeapZeroInitOffset + $hbHeapZeroInitBaseAddr );
    ...
    foreach my $id ( keys %targetAddrHash )
    {
        ...
        {
            my $parent_omic_path = $targetAddrHash{$id}{$omic_parent};

            if ( defined $targetPhysicalPath{$parent_omic_path} )
            {
                my $parent = $targetPhysicalPath{$parent_omic_path};
                unshift @{ $targetAddrHash{$id}{OmicParentAssociations} },
                    $firstTgtPtr + $targetAddrHash{$parent}{OffsetToTargetWithinTargetList};

                unshift @{ $targetAddrHash{$parent}{OmiChildAssociations} },
                    $firstTgtPtr + $targetAddrHash{$id}{OffsetToTargetWithinTargetList};
            }
        }
        ...
        {
            my $parent_pauc_path = $targetAddrHash{$id}{$pauc_parent};

            if ( defined $targetPhysicalPath{$parent_pauc_path} )
            {
                my $parent = $targetPhysicalPath{$parent_pauc_path};
                unshift @{ $targetAddrHash{$id}{PaucParentAssociations} },
                    $firstTgtPtr + $targetAddrHash{$parent}{OffsetToTargetWithinTargetList};

                unshift @{ $targetAddrHash{$parent}{PaucChildAssociations} },
                    $firstTgtPtr + $targetAddrHash{$id}{OffsetToTargetWithinTargetList};
            }
        }
        ...
        if ( defined $targetAddrHash{$id}{$parent_pervasive} )
        {
            ...
            if ( defined $targetPhysicalPath{$parent_pervasive_path} )
            {
                ...
                unshift @{ $targetAddrHash{$id}{ParentPervasiveAssociations} },
                    $firstTgtPtr + $targetAddrHash{$parent}{OffsetToTargetWithinTargetList};

                unshift @{ $targetAddrHash{$parent}{PervasiveChildAssociations} },
                    $firstTgtPtr + $targetAddrHash{$id}{OffsetToTargetWithinTargetList};
            }
        }
        ...
        if ( defined $targetPhysicalPath{$parent_phys_path} )
        {
            ...
            unshift @{ $targetAddrHash{$id}{ParentByContainmentAssociations} },
                $firstTgtPtr + $targetAddrHash{$parent}{OffsetToTargetWithinTargetList};

            unshift @{ $targetAddrHash{$parent}{ChildByContainmentAssociations} },
                $firstTgtPtr + $targetAddrHash{$id}{OffsetToTargetWithinTargetList};
        ...
        if ( defined $targetAffinityPath{$parent_affn_path} )
        {
            ...
            unshift @{ $targetAddrHash{$id}{ParentByAffinityAssociations} },
                $firstTgtPtr + $targetAddrHash{$parent}{OffsetToTargetWithinTargetList};

            unshift @{ $targetAddrHash{$parent}{ChildByAffinityAssociations} },
                $firstTgtPtr + $targetAddrHash{$id}{OffsetToTargetWithinTargetList};
        }
    ...
    my $offsetToAssociationsFromTargets = ( length $targetsBinData ) + ( length $roAttrBinData );
    ...
    ASSOC_IMP( "Size of association section, redundant calculation " . "= $associationsBinDataSize" );
    ...
    $sectionHoH{heapPnorInit}{offset} = $sectionHoH{pnorRo}{offset} + $sectionHoH{pnorRo}{size};
    ...
    $sectionHoH{heapZeroInit}{offset} = $sectionHoH{heapPnorInit}{offset} + $sectionHoH{heapPnorInit}{size};
    ...
    if ($cfgIncludeFspAttributes)
    {
        ...
        $sectionHoH{fspP0DefaultedFromP3}{offset} =
            $sectionHoH{fspP0DefaultedFromZero}{offset} + $sectionHoH{fspP0DefaultedFromZero}{size};
        ...
        $sectionHoH{fspP3Ro}{offset} =
            $sectionHoH{fspP0DefaultedFromP3}{offset} + $sectionHoH{fspP0DefaultedFromP3}{size};
        ...
        $sectionHoH{fspP1DefaultedFromP3}{offset} =
            $sectionHoH{fspP1DefaultedFromZero}{offset} + $sectionHoH{fspP1DefaultedFromZero}{size};
    ...
    if ( $addRO_Section_VerPage == 1 )
    {
        ...
        my $versionHeaderPadSize =
            ( sizeBlockAligned( ( length $versionHeader ), $versionSectionSize, 1 ) - ( length $versionHeader ) );
        $outFile .= pack( "@" . $versionHeaderPadSize );
    }

    #Append the 256 bytes header data
    $outFile .= $headerBinData;
    my $padSize = sizeBlockAligned( ( length $headerBinData ), $headerSize, 1 ) - ( length $headerBinData );
    ...
    ASSOC_DBG( "Offset to associations from start of targets " . "= $offsetToAssociationsFromTargets" );
    ...
    $outFile .= pack( "@" . ( $sectionHoH{heapPnorInit}{size} - $heapPnorInitOffset ) );
    ...
    if ($cfgIncludeFspAttributes)
    {
        ...
        $outFile .= pack( "@" . ( $sectionHoH{fspP0DefaultedFromZero}{size} - $fspP0DefaultedFromZeroOffset ) );

        $outFile .= $fspP0DefaultedFromP3BinData;
        $outFile .= pack( "@" . ( $sectionHoH{fspP0DefaultedFromP3}{size} - $fspP0DefaultedFromP3Offset ) );

        $outFile .= $fspP3RoBinData;
        $outFile .= pack( "@" . ( $sectionHoH{fspP3Ro}{size} - $fspP3RoOffset ) );

        $outFile .= $fspP3RwBinData;
        $outFile .= pack( "@" . ( $sectionHoH{fspP3Rw}{size} - $fspP3RwOffset ) );

        $outFile .= $fspP1DefaultedFromZeroBinData;
        $outFile .= pack( "@" . ( $sectionHoH{fspP1DefaultedFromZero}{size} - $fspP1DefaultedFromZeroOffset ) );

        $outFile .= $fspP1DefaultedFromP3BinData;
        $outFile .= pack( "@" . ( $sectionHoH{fspP1DefaultedFromP3}{size} - $fspP1DefaultedFromP3Offset ) );
    }
    ...
    if ( defined $cfgBiosXmlFile )
    {
        ...
        {
            croak( "BIOS XML file $cfgBiosXmlFile specified, but a BIOS schema " . "file was not.\n" );
        }
        ...
        my $bios = new Bios( $cfgBiosXmlFile, $cfgBiosSchemaFile, $cfgBiosOutputFile );
        $bios->load();
        $bios->processBios( \%attributeDefCacheNoVirtual, \$attributes, \%biosData, %targetPhysicalPath );
        $bios->export();
    }
...
sub generateXMLforSM
{
    ...
    open( SM_TARGET_FILE, ">" . $CfgSMAttrFile )
        or croak( "Targeting SM file: $CfgSMAttrFile " . "could not be opened." );
...
################################################################################
    ...
    sub load
    {
        ...
        eval { $self->{_biosXmlDoc} = $self->{_libXmlParser}->parse_file( $self->{_biosInputXmlFile} ); };

        croak( "Failed to parse BIOS file [$self->{_biosInputXmlFile}].\n" . " Reason: $@" ) if $@;

        eval { $biosSchemaXsd = XML::LibXML::Schema->new( location => $self->{_biosSchemaXsdFile} ); };

        croak( "Failed to load valid schema [$self->{_biosSchemaXsdFile}].\n" . "Reason: $@" ) if $@;

        eval { $biosSchemaXsd->validate( $self->{_biosXmlDoc} ) };
...
################################################################################
    ...
    sub export
    {
        ...
        {
            open( OUTPUT_XML, ">$self->{_biosOutputXmlFile}" )
                or croak( "Could not open output BIOS XML file "
                    . "[$self->{_biosOutputXmlFile}] for writing.\n"
                    . "Reason: $!" );

            print OUTPUT_XML $self->{_biosXmlDoc}->toString()
                or croak( "Failed write output BIOS XML file " . "[$self->{_biosOutputXmlFile}].\n" . "Reason: $!" );

            close OUTPUT_XML
                or croak( "Failed to close output BIOS XML file " . "[$self->{_biosOutputXmlFile}].\n" . "Reason: $!" );
        }
    }
...
################################################################################
    ...
    sub processBios
    {
        ...
        foreach my $attribute ( $self->{_biosXmlDoc}->findnodes('//attribute') )
        {
            ...
            my $complexType = exists $attrMapRef->{$attributeId}{complexType} ? 1 : 0;
            ...
            foreach my $type ( keys %typeHash )
            {
                ...
                {
                    $self->createChildElement( $attribute, "encoding", $typeHash{$type}{generalType} );
                    $attrType  = $type;
                    $validType = 1;
                    last;
                }
            ...
            if ( !$displayNameNodes )
            {
                ...
                {
                    $self->createChildElement( $attribute, "display-name",
            ...
            if ( !$descriptionNodes )
            {
                ...
                {
                    $self->createChildElement( $attribute, "description", $attrMapRef->{$attributeId}{description} );
                }
                else
                {
                    croak(    "BIOS definition specified attribute $attributeId, "
            ...
            if ( scalar @targetRestrictions > 0 )
            {
                ...
                foreach my $targetRestriction (@targetRestrictions)
                {
                    ...
                    my @positionElements = $targetRestriction->findnodes('./position');
                    ...
                    if ( scalar @typeElements )
                    {
                        ...
                        my $typeEnumDef  = ::getEnumerationType( $$attributesRef, "TYPE" );
                        my $numericType  = ::enumNameToValue( $typeEnumDef, $symbolicType );
                    ...
                    foreach my $target ( keys %filteredTargets )
                    {
                        ...
                        if ( scalar @nodeElements > 0 )
                        {
                            ...
                            my $isInSameNodeExpr = quotemeta "physical:sys-0/node-$restrictNode";
                            my $path =
                        ...
                        if ( scalar @unitElements > 0 )
                        {
                            ...
                            if (   ( !exists $filteredTargets{$target}{_identity_}{CHIP_UNIT} )
                                || ( $filteredTargets{$target}{_identity_}{CHIP_UNIT} != $restrictUnit ) )
                            {
                                $filteredTargets{$target}{_allowed_} = 0;
                                next;
                            }
                            ...
                            if ( $checkPosition && ( ( scalar @positionElements ) > 0 ) )
                            {
                                ...
                                my $parent_phys_path = substr( $candidatePath, 0, ( rindex $candidatePath, "/" ) );
                                my $foundPosition = 0;
                                ...
                                while ( defined $targetPhysicalPath{$parent_phys_path} )
                                {
                                    if (defined $filteredTargets{ $targetPhysicalPath{$parent_phys_path} }{_identity_}
                                        {POSITION} )
                                    {
                                        if ( $filteredTargets{ $targetPhysicalPath{$parent_phys_path} }{_identity_}
                                            {POSITION} == $positionElements[0]->to_literal )
                                        {
                                            $foundPosition = 1;
                                        }
                                    ...
                                    $parent_phys_path = substr( $candidatePath, 0, ( rindex $candidatePath, "/" ) );
                                }
                            ...
                            && ( scalar @unitElements == 0 ) )
                        {
                            ...
                            if (   ( !exists $filteredTargets{$target}{_identity_}{POSITION} )
                                || ( $filteredTargets{$target}{_identity_}{POSITION} != $restrictPos ) )
                            {
                                $filteredTargets{$target}{_allowed_} = 0;
                            }
                        }
            ...
            foreach my $target ( keys %filteredTargets )
            {
                    ...
                    && exists $instanceRef->{$target}{$attributeId}{size} )
                {
                    ...
                    {
                        croak( "$target, $attributeId set by multiple BIOS " . "definitions.\n" );
                    }
                    else
                    {
                    ...
                    elsif ( $instanceRef->{$target}{$attributeId}{default} != $default )
                    {
                        croak(    "BIOS definition specified attribute "
            ...
            $self->createChildElement( $targetElement, "type",     sprintf( "0x%08X", $restriction{numericType} ) );
            $self->createChildElement( $targetElement, "node",     sprintf( "0x%02X", $restriction{node} ) );
            $self->createChildElement( $targetElement, "position", sprintf( "0x%04X", $restriction{position} ) );
            $self->createChildElement( $targetElement, "unit",     sprintf( "0x%02X", $restriction{unit} ) );

            my @enumerationOverrideElement = $attribute->findnodes('./enumerationOverride');
            if ( $attrType eq "enumeration" )
            {
                ...
                my $enumerationType = ::getEnumerationType( $$attributesRef, $enumType );
                ...
                if ( scalar @enumerationOverrideElement )
                {
                    ...
                    foreach my $overrideNameElement (
                        $attribute->findnodes('./enumerationOverride/allowedEnumerators/name') )
                    {
                    ...
                    foreach my $enumeratorOverrideElement (
                        $attribute->findnodes('./enumerationOverride/enumeratorOverride') )
                    {
                        ...
                        my @displayName = $enumeratorOverrideElement->findnodes('./display-name');
                        my @description = $enumeratorOverrideElement->findnodes('./description');
                        ...
                        foreach my $enumerator ( @{ $enumerationType->{enumerator} } )
                        {
                            if ( $enumerator->{name} eq $overrideName )
                            {
                                ...
                                {
                                    $enumerator->{'display-name'} = $displayName[0]->to_literal;
                                }

                                if ( scalar @description )
                                {
                                    $enumerator->{description} = $description[0]->to_literal;
                                }
                ...
                my $enumerationElement = $self->createChildElement( $attribute, "enumeration" );
                ...
                foreach my $enumerator ( @{ $enumerationType->{enumerator} } )
                {
                    ...
                    my $enumeratorElement = $self->createChildElement( $enumerationElement, "enumerator" );
                    ...
                    $self->createChildElement( $enumeratorElement, "display-name", $enumerator->{'display-name'} );
                    ...
                    $self->createChildElement( $enumeratorElement, "description", $enumerator->{description} );
                    $self->createChildElement( $enumeratorElement, "value", sprintf( "0x%08X", $enumerator->{value} ) );
                }
            ...
            if ( scalar @numericOverrideElements )
            {
                ...
                my @startElements = @numericOverrideElements[0]->findnodes('./start');
                ...
                foreach my $rangeKey ( sort { $a <=> $b } keys %allowedRange )
                {
                    ...
                    if ( $rangeKey <= $max )
                    {
                        croak( "Range starting with $rangeKey overlaps " . "range ending at $max.\n" );
                    }
            ...
            my $attributeIdEnumeration = ::getAttributeIdEnumeration($$attributesRef);
