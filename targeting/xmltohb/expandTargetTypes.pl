...
sub init
{
    ...
    loadAllowedFilterList( $filterTgtsFile, \%reqTgts,
        "/allowedTargets/targetType", \$user_provided_tgt_filter_is_active );

    loadAllowedFilterList(
        $filterAttrFile, \%reqAttr,
