...
echo "Running: $COMMON_XMLTOHB_REL_PATH/$XMLTOHB_TARGET_MERGE_SCRIPT --common=${COMMON_XMLTOHB_REL_PATH}/${XMLTOHB_COMMON_TARGET_TYPES} --plat=${TARGETING_XMLTOHB_REL_PATH}/${XMLTOHB_BMC_TARGET_TYPES} > ${GENDIR}/${XMLTOHB_SRC_TARGET_TYPES}"
"$COMMON_XMLTOHB_REL_PATH/$XMLTOHB_TARGET_MERGE_SCRIPT" \
  --common="${COMMON_XMLTOHB_REL_PATH}/${XMLTOHB_COMMON_TARGET_TYPES}" \
  --plat="${TARGETING_XMLTOHB_REL_PATH}/${XMLTOHB_BMC_TARGET_TYPES}" \
...
echo "Running target merge script and $XMLTOHB_SWAP_MAPPED_ATTR_SCRIPT... to create $XMLTOHB_FULL_TARGET_TYPES"
"$COMMON_XMLTOHB_REL_PATH/${XMLTOHB_TARGET_MERGE_SCRIPT}" \
